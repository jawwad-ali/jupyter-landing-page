...
const navlinks = ["Features", "Widgets", "Shop", "Blog", "Portfolio", "Demos"];
...
const Navbar = () => {
  return (
    <div className={`hidden lg:flex flex-1 h-[90px] lg:max-w-[81.5rem] mx-auto`}>
      {/* Logo */}
      ...
      <div className="flex flex-[0.1] justify-end items-center">
        <button
          ...
          style={{
            backgroundImage: "linear-gradient(90deg, #EC33C8 2%, #3319CB 100%)",
          }}
        >
          Buy JupiterX
        </button>
